...
typedef struct {
    ...
    XHeap_sort_uio_map maps[ MAX_UIO_MAPS ];
} XHeap_sort_uio_info;

/***************** Variable Definitions **************************************/
static XHeap_sort_uio_info uio_info;
...
static int uio_info_read_name(XHeap_sort_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XHeap_sort_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XHeap_sort_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XHeap_sort_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XHeap_sort_Initialize(XHeap_sort *InstancePtr, const char* InstanceName) {
	XHeap_sort_uio_info *InfoPtr = &uio_info;
