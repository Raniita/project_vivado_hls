#pragma line 1 "D:/trabajo_DSE_EnrLuc/sources/heap_sort_tb.cpp"
...
#pragma line 7 "D:/trabajo_DSE_EnrLuc/sources/heap_sort_tb.cpp" 2
#pragma empty_line
#pragma empty_line
#pragma empty_line
...
#pragma empty_line
#pragma empty_line
void buildMaxHeap_sw(int array[40]){
 for (int i = 1; i < 40; i++){
#pragma empty_line
...
#pragma empty_line
void heap_sort_sw(int array[40], int array_out[40]){
#pragma empty_line
 int c;
    for(c=0;c<40;c++){
        array_out[c] = array[c];
...
#pragma empty_line
void heap_sort(int array[40], int array_out[40]);
#pragma empty_line
void print_array(int array[40]){
 int i;
    printf("\n");
 for(i=0;i<40;i++){
  printf("%d", array[i]);
...
#pragma empty_line
void print_array_sw_hw(int array_sw[40], int array_hw[40]){
...
#pragma empty_line
    int array1[40] = {57,-172,337,44,7,296,88,379,-23,254,314,159,149,154,-53,334,31,144,204,344,324,175,294,15,107,208,192,190,25,301,-88,94,250,171,-180,-85,345,200,392,-71};
#pragma empty_line
    int array1_out_sw[40];
    int array1_out_hw[40];
#pragma empty_line
#pragma empty_line
