...
$(ObjDir)/heap_sort_tb.cpp_pre.cpp.tb.o : heap_sort_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling heap_sort_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/heap_sort.cpp_pre.cpp.tb.o : heap_sort.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling heap_sort.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
